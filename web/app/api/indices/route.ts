...
// Live market-indices strip for the Today page (TSX/S&P/DJIA/NASDAQ/Gold/Oil). Cookie-gated by
// middleware (no Bearer entry). A short in-process cache means many open tabs share one FMP hit
// while the strip polls until the close. (CAD/USD left this payload 2026-07-04 — the masthead's
// loonie pill is the one FX readout; it renders server-side off fmpCadUsd.)
