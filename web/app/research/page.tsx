...
import { money, pct, fmtDay, fmtWhen } from "@/lib/money";
...
export default async function Research() {
  ...
  return (
    <main>
      <PageHeader
        title="Research"
        sub="Your desk for digging into stocks — look one up, jot what you find. The agent's own research pipeline is at the bottom."
        right={
          <Link href="/stocks">
      ...
      <section className="mt-10 border-t border-teal-400/10 pt-6">
        ...
        <p className="mb-4 text-xs text-teal-200/40">
          What the agent is auto-researching, and the universe candidates it&apos;s vetting for promotion — behind-the-scenes plumbing.
        </p>
        ...
        <Card className="mb-6 border-teal-400/30 p-4">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            {queued.length > 0 ? (
              ...
              <span className="text-sm text-teal-200/40">Nothing queued — look up a name above, or hit “research now” on any stock page.</span>
            ) : null}
