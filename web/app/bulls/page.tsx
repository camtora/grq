    ...
    <main>
      ...
      {races.length === 0 || !data ? (
        ...
        <>
          ...
          <details open className="mb-4 rounded-2xl border border-[color:var(--card-border)] bg-[var(--card-bg)] p-4">
            ...
            <ul className="mt-3 space-y-2 text-xs leading-relaxed text-teal-100/70">
              ...
              <li>
                <span className="font-semibold text-teal-50">Level field.</span> Every bull runs seed-only / no-tools — even Opus — so this measures judgment, not who has the better research shovel. (The real Opus fund, which <em>does</em> use tools, is shown only as a reference below.)
              </li>
              <li>
          ...
          <h2 className="mb-2 mt-6 text-sm font-semibold uppercase tracking-wider text-teal-200/50">Leaderboard</h2>
