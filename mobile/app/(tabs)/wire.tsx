...
const s = StyleSheet.create({
  ...
  identitySym: { fontFamily: 'System', fontWeight: '800', fontSize: 20 },
  ...
  heroStatValue: { fontFamily: 'System', fontWeight: '800', fontSize: 40, letterSpacing: -0.5 },
  ...
  lessonTerm: { fontFamily: 'System', fontWeight: '800', fontSize: 24, marginTop: 4 },
