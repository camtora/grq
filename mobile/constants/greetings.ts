// Wealth-aware greetings — mirror of web/lib/greetings.ts (the canonical,
// Alfred-era lines; shared/content/daily.json still has the pre-rename copy).
// Deterministic per member per day. Loss jokes punch at Alfred, never the member.
