...
| 2026-06-12 (Cam) | **Light mode + dark mode** — theme toggle. Current design is dark-native; a light teal theme needs a real design pass (not just inverted colors). Respect `prefers-color-scheme`, persist the choice per member. |
